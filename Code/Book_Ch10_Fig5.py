...
ax.plot(ei['year'],ei['energy_pop'],c='black',lw=2)

ax.set_xlabel('Year', fontsize=14)
ax.set_ylabel('Energy use per capita (million BTU)', fontsize=14)
ax.set_xticks(np.arange(1950,2025,5))

#plt.show()
location = os.path.abspath(os.path.dirname(__file__))
path = os.path.join(location, "../Figures/fig-ch10-fig5.eps")
